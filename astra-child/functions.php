 ...
 */
@include 'functions/events-manager_shortcode_wiederkehrende-veranstaltungen.php';

/**
 * Shortcodes for advanced notice in menu "Zweigstellen".
 */
@include 'function/events-manager_shortcode_zweigstellen.php';

/**
 * Shortcodes for advanced notice in menu "Meditationskurse".
 */
@include 'function/events-manager_shortcode_meditationskurse.php';
